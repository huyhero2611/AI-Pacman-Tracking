        ...
        *** GORY DETAIL AHEAD ***
        ...
        for position in self.legalPositions:
            ...
            for newPosition, probability in newDistribution.items():
                allPossible[newPosition] += (self.beliefs[position]
                                             * probability)
...
class ParticleFilter(InferenceModule):
        ...
        if noisyDistance == None:
            ...
            for legal_location in self.legalPositions:
                true_distance = util.manhattanDistance(
                    legal_location, pacmanPosition)
                all_possible[legal_location] = all_possible[legal_location] + \
                    (emissionModel[true_distance] * old_belief[legal_location])
    ...
    def elapseTime(self, gameState):
        ...
        """
        "*** YOUR CODE HERE ***"
        new_posterior = map(lambda x: self.getPositionDistribution(
            self.setGhostPosition(gameState, x)), self.particles)
...
class JointParticleFilter:
    ...
    def initializeParticles(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        particle_positions = list(itertools.product(
